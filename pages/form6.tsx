...
const Form6 = ()=>{
    return(
        <div className={styles.form}>
            ...
            <h1 className="text-center"><b>PROMISSORY NOTE & INSTALLMENT PAYMENT PLAN FOR UNPAID PREMIUM</b></h1>
...
order of <input/> (“Bail Producer”) the principal sum of
<input/> ($<input/>) owed for the bail bond (“Bond”) of <input/>
(“Defendant”) at the address shown above in the Bail Producer Stamp box or at such other place as Bail Producer may from time to
...
<p className="mt-12">6. I (we) agree to all terms and conditions of this note and acknowledge receipt of a copy of this note. I (we) also agree to pay all
collection costs including, w</p>
