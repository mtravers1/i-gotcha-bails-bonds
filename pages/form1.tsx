...
true, complete and correct and are made for the purpose of inducing Lexington National Insurance Corporation (“Surety”) to issue, or cause to be issued, bail
...
<div>
    ...
    <div className="border-2 border-black p-2 ">
        ...
        <span className="flex items-end justify-between">
            ...
            <span className="flex">
                <p className="w-1/5">Any Medical Conditions/Disabilities</p><input className="w-full"/>
            </span>
...
{/*---------------------------- 6. Arrest Info --------------------*/}
    ...
    <div className="border-2 border-black p-2 ">
        <span className="flex items-end justify-between">
            <span className="w-1/4">
                Date of Arrest<input className="w-9/12"/>
            </span>
            <span className="w-2/4">
                Booking Name (if different)<input className="w-9/12"/>
            </span>
            <span className="w-1/4">
                Arresting Agency<input className="w-8/12"/>
            </span>
            
            </span>
            <span className="flex items-end justify-between">
            <span className="w-2/3">
                Jail Location<input className="w-9/12"/>
            </span>
            <span className="w-1/3">
            ...
            <span className="flex items-end justify-between">
            <span className="w-2/3">
                Charges<input className="w-9/12"/>
            </span>
            </span>
            ...
            <span>
                <span className="flex justify-between mr-20">
                    ...
                    <p>Charges</p><p>Date</p><p>Where</p></span>
...
{/* ------------------------------------------6. ----------------------------*/}
    ...
    <div className="border-2 border-black p-2 ">
        <span className="flex items-end justify-between">
            <span className="w-1/2">
                Name and Firm<input className="w-10/12"/>
            </span>
            <span className="w-1/2 ">
            Phone Number<input className="w-10/12"/>
            </span>
...
<div>
    ...
    <div className="border-2 border-black p-2 ">
        <span className="flex items-end justify-between ">
            <span className="w-10/12">
                <span className="font-bold"> Father's Name<input className="w-2/5 mr-20"/></span>
                <span> Address<input className="w-2/5"/></span>
            ...
            <span className="flex justify-between">
                <span className="w-1/3">
                    Home Phone<input className="w-3/4"/>
                </span>
                <span className="w-1/3">
            ...
            <span className="flex justify-between">
                <span className="w-2/4">
                    Email<input className="w-3/4"/>
                </span>
                <span className="w-2/4">Employer<input  className="w-3/4"/>
                </span>
            </span>
            <span className="flex items-end justify-between">
            <span className="w-11/12">
                <span className="font-bold"> Mothers's Name<input className="w-2/5 mr-20"/></span>
                <span> Address<input className="w-2/5"/></span>
            ...
            <span className="flex items-end justify-between">
            <span className="w-11/12">
                <span className="font-bold"> Other Relative/Friend's Name<input className="w-2/5 mr-10"/></span>
                <span> Relationship<input className="w-1/8"/></span>
                <span>How Long Known:<input /></span>
...
{/* ---------------------------9.Notes----------------- */}
    ...
    <div className="border-2 border-black p-2 ">
        ...
        <div>
            <h1 className="font-bold text-center">BAIL BOND APPLICATION AND AGGREEMENT<br/>Terms and Condition</h1>
            <p className="ml-10">In consideration of Surety, through its producers, representatives or designees, issuing or causing to be issued the Bond, you agree</p>

<p>to the following terms and conditions:<br/>
    
1. The premium is fully earned upon your release from custody. The premium is not refundable except as stated below.<br/>
...
your failure to appear in court, and for reason other than as stated in Paragraph 3, then you may be entitled to a refund of the bond
premium if required by applicable law (if any) as stated in an attached addendum.<br/>
...
any collateral or security given for the Bond depreciates in value or becomes impaired, or (j) Other Conditions:</p><br/>
<input className="w-full"/><br/>

<p className="ml-10 font-bold">4. You shall indemnify the Surety and keep the Surety indemnified and hold it harmless from and against any and all losses,</p>
...
requisite funds to meet any such claim, demand, liabili
            </p>
<p className="ml-10">5. To the maximum extent permitted by applicable law, you hereby waive any and all rights you may have under federal law</p>
<p >
...
you waive any and all causes of action in connection therewith including, without limitation, torts of trespass and false imprisonment</p>

<p className="ml-10">6. You agree that Surety may attach a location tracking device on any vehicle owned or driven by you, at any time, without notice,</p>
<p>and monitor the location of the vehicle through any available technology. You further agree that Surety may use location technologies to
...
DURING THE BAIL PERIOD; and (g) all questions relating to location capability should be directed to Surety</p>
<p className="ml-10">7. If you leave the State, subject to applicable law, you waive any right to extradition proceedings and consent to the application of</p>
such force as may be necessary to return you to Surety and the court where the Bond was posted.
<p className="ml-10">8. You hereby acknowledge and agree that neither the Surety nor any of its agents, producers, designees or representatives has</p>
recommended or suggested any specific attorney or firm of attorneys to represent you in any capacity.
<p className="ml-10">9. In the event any provision herein shall be deemed to exceed any applicable state or federal law, then such provision shall</p>
<p>automatically be deemed to have been revised to comply with such law so as to provide Surety with the maximum protection from any loss
...
contemplated hereby, and you shall not, and expressly waive any right to, assert the claim or defense that Assignee does not have the right
to enforce such rights in any such action or proceeding</p>
        </div>
        <span className="flex justify-between">
            <span className="w-1/4 text-center">
            Bail Standard Form No. 1<br/>
...
penalties
        ...
        <div className="m-5 flex flex-col">
            <span>Signed, scaled and delivered this<input/> day of <input/>, 20<input/></span>
            <span>Signature ofr Defendant<input className="w-1/3"/></span>
        </div>
