...
const Form8 = ()=>{
    ...
    return(
        ...
        <div className={styles.form}>
            <div>
          <h2 className="text-center font-bold text-3xl m-8">INDEMNITOR APPLICATION AND AGGREEMENT</h2>
        <p className=""><span className="ml-24"/> You, the undersigned indemnitor (“Indemnitor” or “you”), hereby represent and warrant that the following declarations made
and answers given are true, complete and correct and are made for the purpose of inducing Lexington National Insurance Corporation
(“Surety”) to issue, or cause to be issued, bail bond(s) or undertaking(s) (singularly or collectively the “Bond”) for
<input className="w-3/4 "/> (“Defendant”), using power of attorney 
<span className="ml-12 flex w-1/2 justify-between"><p>First</p>
<p>Middle</p>
<p>Last</p>
</span>
<input />, in the total amount of <input className="w-80  "/> Dollars, $<input className=""/> in the
<input className=""/> Court of <u><input className="w-1/4"/></u></p>
</div>
{/* ------------------------------------------Box1--------------------- */}
...
Email<input className="w-11/12 m-1"/>
</span>
<span className="">Facebook username</span><input className=" w-1/4"/> 

Other social media<input className=" w-1/4 m-1"/>
</div>
<span className="flex items-end justify-between">
Current Home Address<input className="w-10/12  m-1"/>
</span>

<div className="flex items-end justify-between">
    <span  className="w-1/2">
How Long <input className=" w-10/12 "/></span> 
<span className="w-1/12"><input type="radio"/>Rent or <input type="radio"/> Own </span>

<span className="w-2/4 flex">
<p className="w-4/12">Landlord/Mortgage Holder</p><input className=" w-10/12 m-1"/>
</span>
</div>
{/* <div>
...
<div>
    ...
    <div className="border-2 border-black p-2 ">
        ...
        <span className="flex items-end justify-between">
            <span className="w-1/8">Date of Birth <input className=""/>
            </span>
            <span className="w-5/12">City and State Born<input className="w-3/4"/>
            </span>
            <span className="w-1/8">
                 Male<input type="radio"/>Female<input type="radio"/>
                 </span>
            <span className="w-1/4 flex"><p>Race</p> <input className="w-11/12"/>
            </span>
        ...
        <span className="flex items-end justify-between">
            ...
            <span className="flex items-end justify-between">
                <span className="w-1/8">
            U.S. Citizen <input type="radio"/>Yes<input type="radio"/>No
            </span>
            <span className="w-1/4">
                How Long in US<input className="w-8/12"/>
            </span>
            <span className="w-1/4">
               Nationality<input className="w-8/12"/>
            </span>
            <span className="w-1/4 flex">
                <p>Alien#</p><input className="w-full"/>
            </span>
            
            </span>
            <span className="flex">
                <p className="w-1/5">Additional Notes</p><input className="w-full"/>
            </span>
    ...
    <div className="border-2 border-black p-2 ">
        ...
        <span className="flex items-end justify-between">
            <span className="w-2/3">
               Employer Address<input className="w-10/12"/>
            </span>
            <span className="w-1/3 flex">
...
{/*         
        ...
        <span className="flex items-end justify-between">
            ...
            <span className="flex items-end justify-between">
                <span className="w-1/6">
                    Union<input className="w-10/12"/>
                </span>
                <span className="w-1/6">
                    Local #<input className="w-9/12"/>
                </span>
                <span className="w-2/6">
                    Military Service: Branch<input className="w-8/12"/>
                </span>
                <span>
...
<div>
    ...
    <div className="border-2 border-black p-2 ">
        ...
        <span className="w-1/3 flex">
            <p className="w-1/3">Social Security #</p><input className="w-full"/>
        </span>
        </span>
        ...
        <span className="w-3/5">
            Address (if different)<input className="w-9/12"/>
        </span>
        <span className="w-2/5 flex">
            <p>Email</p><input className="w-full"/>
        </span>
        </span>
        ...
        <span className="flex items-end justify-between">
        <span className="w-1/3">
            Home Phone #(if different)<input className="w-2/4"/>
        </span>
        <span className="w-1/3">
        ...
        <span className="flex items-end justify-between">
        <span className="w-2/3">
            Employer<input className="w-10/12"/>
        </span>
        <span className="w-2/3">
            Position<input className="w-10/12"/>
        </span>
        <span className="w-1/3 flex">
            <p className="w-1/3">How Long</p><input className="w-full"/>
        </span>
        </span>
        ...
        <span className="flex items-end justify-between">
        <span className="w-1/4 flex">
            <p className="w-1/4">Childs Name</p><input className="w-11/12"/>
        </span>
        <span className="w-1/4 flex">
            <p className="w-2/6">Date of Birth</p><input className="w-11/12"/>
        </span>
        <span className="w-1/4 flex">
            <p>School/Employer</p><input className="w-11/12"/>
        </span>
        <span className="w-1/4 border-t-1 flex">
           <p className="w-3/5">Other Parent's Name</p> <input className="w-full"/>
        </span>
        </span>
    ...
    <div className="border-2 border-black p-2 ">
        <span className="flex items-end justify-between">
            ...
            <span className="w-1/6">
                Make<input className="w-9/12" />
            </span>
            <span className="w-1/6">
                Modle<input className="w-9/12"/>
            </span>
            <span className="w-1/6">
                Color<input className="w-9/12"/>
            </span>
            <span className="w-1/6">
            ...
            <span className="w-3/6 flex">
                <p className="w-1/6">Where Financed </p><input className="w-full"/>
            </span>
            <span className="w-3/6 flex">
                <p className="w-1/6">Amount Owed $ </p><input className="w-full"/>
            </span>
            </span>
        {/* <span className="flex items-end justify-between">
            <span className="w-1/3">
...
{/* ---------------------------9.Notes----------------- */}
    ...
    <div className="border-2 border-black p-2 ">
        ...
        <div>
            <p className="ml-10">THIS INDEMNITY AGREEMENT (“Agreement”) is entered into between you, the undersigned Indemnitor, and Surety through
Surety’s duly appointed independent bail producer referenced below (“Producer”). </p>

<p>
<p className="ml-10 ">
    
1.You will have Defendant appear in any court required in connection with the Bond at the times stated in the Bond and all other
times as may be ordered by the court<br/>
<p><b>2. You, jointly and severally (together and separately) with any other indemnitor, shall indemnify the Surety and keep the
...
evidence of any payment made by Surety or Producer, by reason of such suretyship, shall be conclusive evidence of such
payment in any lawsuit against you both as to the propriety of such payment and as to the extent of your liability to
...
redemption.
<br/>5. If a confession of judgment is taken in connection with the Bond, the Surety shall have the right to enter and file the same at
...
<br/>6. You acknowledge and agree that the Surety may foreclose any or all of the liens and security interests arising out of the
...
<br/>7. Subject to applicable law (if any) as stated in an attached addendum, the Surety will return the collateral to you when all of the
...
services rendered.
<br/>8. The Surety shall have the right to transfer and/or assign, in whole or in part, its rights and obligations in this Agreement, and/or
...
<br/>9. This Agreement and all documents that are executed in connection with this Agreement set forth all the terms of the agreement
...
<br/>10. You hereby acknowledge and agree that neither the Surety nor its Producer has recommended or suggested any specific
attorney or firm of attorneys to represent the Defendant in any capacity.
<br/>11. This Agreement may not be terminated or modified orally. All modifications and terminations of this Agreement, including
any release of your liability hereunder, must be in writing and signed by the Surety and you.
<br/>12. To the maximum extent permitted by applicable law, you hereby waive any and all rights you may have under federal law
...
<br/>13. You agree that Surety may attach a location tracking device on any vehicle owned or driven by you, at any time, without notice,
...
<br/>14. In the event any provision herein shall be deemed to exceed any applicable state or federal law, then such provision shall
...
<br/>15. You have not been paid to sign this Agreement. You have read the above contract, understand it and agree to fulfill ALL of the
provisions therein.
</p>
...
<br/>
<br/><h1 className="underline">ARKANSAS RESIDENTS</h1>
Any person who knowingly presents a false or fraudulent claim for payment for a loss or benefit or knowingly
presents false information in an application for insurance is guilty of a crime and may be subject to fines and
confinement in prison.
<br/>
<br/><h1 className="underline">FLORIDA RESIDENTS</h1>
...
<br/>
<br/><h1 className="underline">LOUISIANA, RHODE ISLAND & WEST VIRGINIA RESIDENTS</h1>
Any person who knowingly presents a false or fraudulent claim for payment of a loss or benefit or knowingly
presents false information in an application for insurance is guilty of a crime and may be subject to fines and
confinement in prison.
<br/>
<br/><h1 className="underline">MAINE, TENNESSEE, VIRGINIA & WASHINGTON RESIDENTS</h1>
...
<br/>
<br/><h1 className="underline">MARYLAND RESIDENTS</h1>
...
PENALTIES.
<br/>
<br/><h1 className="underline">OHIO RESIDENTS</h1>
...
<br/>
<br/><h1 className="underline">OKLAHOMA RESIDENTS</h1>
...
of a felony.
<br/>
<br/><h1 className="underline">PENNSYLVANNIA RESIDENTS</h1>
...
and subjects such person to criminal and civil penalties.<br/>
<br/>
</b>
</div>
        ...
        <p>Any person who knowingly presents a false or fraudulent claim for payment of a loss or benefit or who knowingly presents false
...
penalties
        ...
        <div className="m-5 flex flex-col">
            <span>Signed, SEALED AND DELIVERED  at<input/> day of <input/>, 20<input/></span>
        </div>
...
P.O. Box 6098<br/>
Lutherville, Maryland 21094<br/>
Phone: 888-888-2245<br/><br/><br/>

                </span>
                <span className="border-2 w-1/3">
                Bail Producer Stamp: [must include name, address, phone no.
and license no.]<br/>
