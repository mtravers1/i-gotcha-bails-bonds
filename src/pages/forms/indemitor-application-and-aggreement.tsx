        ...
        <div>
          ...
          <div>
            <p className="ml-10">
              ...
              you, the undersigned Indemnitor, and Surety through Surety’s duly
              appointed independent bail producer referenced below (“Producer”).{' '}
            </p>

            <p>
              <p className="ml-10 ">
                1.You will have Defendant appear in any court required in
                connection with the Bond at the times stated in the Bond and all
                other times as may be ordered by the court
                <br />
                <p>
                  <b>
                    2. You, jointly and severally (together and separately) with
                    any other indemnitor, shall indemnify the Surety and keep
                    the Surety indemnified and hold it harmless from and against
                    any and all losses, demands, liabilities, fees and expenses
                    relating to, or arising out of, Surety’s issuance or
                    procurement of the Bond, including, but not limited to the
                    following: (a) the principal amount of any forfeiture of, or
                    judgment on, the Bond, plus any related court costs,
                    interest and legal fees incurred, (b) a fugitive recovery
                    fee if there is a forfeiture of the Bond (which fee is
                    typically ten percent of the amount of the Bond for an
                    in-state recovery, plus any out of pocket expenses), (c) any
                    and all extradition costs that may be incurred to apprehend
                    and return the Defendant, and (d) if a collection action is
                    required, reasonable and actual attorneys’ fees plus any and
                    all other costs, expenses and/or assessments that may be
                    incurred as a result of any forfeiture of the Bond subject
                    to applicable law (if any) as stated in an attached
                    addendum. The voucher, check or other evidence of any
                    payment made by Surety or Producer, by reason of such
                    suretyship, shall be conclusive evidence of such payment in
                    any lawsuit against you both as to the propriety of such
                    payment and as to the extent of your liability to Surety for
                    such payment. Further, you will, upon demand, place with
                    Surety the requisite funds to meet any such claim, demand,
                    liability, attorneys’ fees, expense or judgment, whether
                    that demand is made before or after Surety has paid or
                    advanced such funds.
                  </b>
                </p>
                <br />
                ...
                deposited as security for the payment of any and all monies and
                sums due to Surety or Producer, including all liability,
                demands, damages, judgments, interest, attorneys’ fees and costs
                suffered, sustained, made or incurred by Surety or Producer on
                account of, arising out of or relating to the Bond and
                ...
                Agreement, and any and all debt or other obligations arising out
                of or evidenced by any agreement executed by Defendant, you or
                any other indemnitor for the benefit of Surety or Producer
                (“Liabilities”); and (b) if you grant the Surety a lien or a
                security interest in any property or collateral to enforce the
                obligations contained in this Agreement, and if you do not
                perform all of your obligations in this Agreement, you authorize
                the Surety to (i) apply or sell any collateral security you
                deposited to reimburse the Surety for any and all Liabilities of
                any kind or nature, (ii) hold, apply or sell the collateral, or
                any part thereof, to protect or reimburse the Surety by reason
                of the execution at any time of any other bond for or on behalf
                of you or Defendant, and (iii) apply and sell the collateral for
                the purpose of placing the Surety in cash funds or protecting
                the Surety against any claim, demand or loss under the Bond or
                any other bond executed on your or Defendant’s behalf. Subject
                to applicable law (if any) as stated in an attached addendum,
                the Surety may make any such sale, at its discretion, at public
                or private sales, and without demand, notice or advertisement of
                the time and place of said sale, and also with the right to
                purchase said collateral at such sale or sales, freed and
                discharged from any equity or redemption.
              </p>
              <br />
              ...
              its protection, upon request of the Surety, you shall provide the
              Surety with additional and satisfactory collateral so that the
              total market value of the collateral shall, at all times, be equal
              to the market value of the collateral at the time of its initial
              deposit. Subject to applicable law (if any) as stated in an
              attached addendum, if you fail to deposit such additional
              ...
              also with the right to purchase said collateral at any such sale,
              freed and discharged from any equity or redemption.
              <br />
              ...
              preference against any of your property, whether or not the Surety
              is indemnified at the time of the filing or entry of such
              judgment. In case a confession of judgment is filed by the Surety
              against you, the judgment entered shall be effective and available
              to the Surety against you not only in connection with the Bond but
              also in connection with any other bond that may have been written
              by the Surety in which you are either the indemnitor or defendant.
              <br />
              6. You acknowledge and agree that the Surety may foreclose any or
              all of the liens and security interests arising out of the
              ...
              obligated to enforce its rights against any security or collateral
              prior to enforcing its rights against you or any other indemnitor.
              <br />
              7. Subject to applicable law (if any) as stated in an attached
              addendum, the Surety will return the collateral to you when all of
              the following are satisfied: (i) the Surety receives competent
              written legal evidence satisfactory to the Surety (for example,
              written notice from the court) of the Surety’s discharge or
              release from all liability under the Bond; (ii) there are no
              outstanding Liabilities of any kind arising out of or relating to
              the Bond; (iii) there are no other outstanding bonds or
              obligations executed by, for or on behalf of you or Defendant in
              connection with which the Surety may deem it advisable to retain
              such collateral for its protection; and (iv) upon the Surety’s
              request, you shall have executed and delivered to the Surety a
              general release upon the Surety’s return of the collateral to you.
              If the Surety deems it necessary to make any outlay to protect any
              collateral or security in its possession, whether the same be real
              or personal property, you authorize the Surety to do so, and you
              agree to indemnify and reimburse the Surety for any such outlay as
              in the judgment of the Surety may be necessary to protect its
              collateral or security, including payment of taxes or liens or
              mortgages and any attorneys’ fees or service fees for time spent
              and/or special services rendered.
              <br />
              ...
              (“Assignee”) without notice to or consent from you. Subject to any
              limitations imposed upon Assignee by the Surety, Assignee shall
              have the right to enforce in any action, proceeding or otherwise
              any of the Surety’s rights herein or arising out of any of the
              transactions contemplated hereby, and you shall not, and expressly
              waive any right to, assert the claim or defense that Assignee does
              not have the right to enforce such rights in any such action,
              proceeding or otherwise. If more than one bond is made or has been
              made for the Defendant, then this Agreement shall extend to and
              cover all those bonds and the terms of this Agreement shall apply
              to each bond individually or as a group.
              <br />
              ...
              its Producer has recommended or suggested any specific attorney or
              firm of attorneys to represent the Defendant in any capacity.
              <br />
              ...
              release of your liability hereunder, must be in writing and signed
              by the Surety and you.
              <br />
              12. To the maximum extent permitted by applicable law, you hereby
              waive any and all rights you may have under federal law
              (including, but not limited to, Title 28 Privacy Act-Freedom of
              Information Act, Title 6, Fair Credit Reporting Act) and any local
              or State law relating to Surety’s obtaining, and you consent to
              and authorize Surety to obtain, any and all private or public
              information and/or records concerning you from any party or
              agency, private or governmental (local, state, federal),
              including, but not limited to, credit reports, Social Security
              Records, criminal records, civil records, driving records, tax
              records, telephone records, medical records, school records,
              worker compensation records, and employment records. You further
              authorize, without reservation, any party or agency, private or
              governmental (local, state, federal), contacted by Surety to
              furnish in accordance with applicable law any and all private and
              public information and records in their possession concerning you
              to the Surety and direct that a copy of this document shall serve
              as evidence of said authorization. You irrevocably grant to surety
              and its producers, agents and representatives the right to enter
              your residence or other property owned or occupied by you or
              Defendant without notice, at any time, for the purpose of
              locating, arresting, and returning to custody the Defendant, and
              subject to applicable law, you waive any and all causes of action
              in connection therewith including, without limitation, torts of
              trespass and false imprisonment.
              <br />
              13. You agree that Surety may attach a location tracking device on
              any vehicle owned or driven by you, at any time, without notice,
              and monitor the location of the vehicle through any available
              technology. You further agree that Surety may use location
              technologies to locate your wireless device at any time during the
              period of Defendant’s bail and any applicable remission period,
              and the Bond is conditioned upon your full compliance with the
              following terms and conditions: (a) Surety, at its discretion,
              will use network-based location technologies to find you; (b) this
              is the only notice you will receive for the collection of your
              location information; (c) Surety will retain location data only
              while the Bond is in force and during any applicable remission
              period; (d) Surety will disclose location information only to the
              courts as required by court order; (e) Surety and its licensed
              producers, designees and representatives will be the only persons
              with access to your location information; (f) YOU WILL NOT HAVE
              THE OPTION TO OPT-OUT OF LOCATION USE OR TRACKING DURING THE BAIL
              PERIOD; and (g) all questions relating to location capability
              should be directed to Surety.
              <br />
              ...
              the above contract, understand it and agree to fulfill ALL of the
              provisions therein.
            </p>
          ...
          <div className="font-bold">
            ...
            <p>
              ...
              payment of a loss or benefit or who knowingly presents false
              information in an application for insurance is guilty of a crime
            ...
            SUBJECT TO CIVIL FINES AND CRIMINAL PENALTIES. NEW YORK RESIDENTS -
            ...
            crime and subjects such person criminal and civil penalties
          </div>
